...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-corporate-steel via-corporate-darkSteel to-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        >
          <div className="flex items-center justify-center mb-6">
            ...
            <div>
              <h1 className="text-5xl font-bold text-white mb-2">ЕВРАЗ КГОК</h1>
              <div className="h-1 w-32 bg-gradient-to-r from-corporate-red to-corporate-gold mx-auto"></div>
            </div>
          </div>
          
          <Badge variant="outline" className="bg-corporate-gold/20 text-corporate-gold border-corporate-gold/50 text-lg px-6 py-2">
        ...
        {/* Main greeting card */}
        <Card 
          className={`max-w-4xl mx-auto bg-white/95 backdrop-blur-sm border-2 border-corporate-gold/30 shadow-2xl transition-all duration-1000 delay-500 ${
        ...
        >
          <div className="p-12">
            ...
            <div className="text-center mb-12">
              <div className="flex items-center justify-center mb-6">
                <Icon name="Sparkles" size={32} className="text-corporate-gold mr-3" />
                <h2 className="text-4xl font-bold text-corporate-steel">
                  ПОЗДРАВЛЕНИЕ
                </h2>
                <Icon name="Sparkles" size={32} className="text-corporate-gold ml-3" />
              </div>
              
              <div className="bg-gradient-to-r from-corporate-red to-corporate-gold h-0.5 w-48 mx-auto mb-8"></div>
              
              <p className="text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
                От всей души поздравляем коллектив <span className="font-bold text-corporate-red">ЕВРАЗ КГОК</span> 
            ...
            <div className="bg-gradient-to-r from-corporate-steel/5 to-corporate-red/5 rounded-2xl p-8">
              <div className="text-center mb-8">
                <h3 className="text-3xl font-bold text-corporate-steel mb-4 flex items-center justify-center">
                  <Icon name="Heart" size={28} className="text-corporate-red mr-3" />
                  ПОЖЕЛАНИЯ
                  <Icon name="Heart" size={28} className="text-corporate-red ml-3" />
                </h3>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-corporate-steel mb-2">Развития и роста</h4>
                      <p className="text-gray-700">Пусть каждый новый год приносит новые достижения и покорение производственных высот</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-corporate-steel mb-2">Безопасности</h4>
                      <p className="text-gray-700">Пусть безопасность труда остается приоритетом, а каждый рабочий день заканчивается благополучно</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-corporate-steel mb-2">Достижения целей</h4>
                      <p className="text-gray-700">Пусть все поставленные задачи решаются успешно, а планы реализуются с превышением показателей</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-corporate-steel mb-2">Единства коллектива</h4>
                      <p className="text-gray-700">Пусть крепнет сплоченность команды, а корпоративный дух вдохновляет на новые свершения</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="text-center mt-12">
              ...
              <p className="text-lg text-corporate-steel font-medium">
